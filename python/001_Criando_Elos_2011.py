...
df_pc2008_1 = df[df['Data'] >= '2011-01-01 00:00:00']
df_pc2008 = df_pc2008_1[df_pc2008_1['Data'] < '2012-01-01 00:00:00']
...
for index, row in jogos.iterrows():
    ...
    if cont_atl_mg == 0:
        Rt_Atletico_mg = 998.28
    if cont_amr_mg == 0:	
        Rt_americamg =998.76
    if cont_atl_pr == 0:
        Rt_athletico_pr = 1009.25
    if cont_atl_go == 0:	
        Rt_atletico_go = 1004.73
    if cont_avai == 0:	
        Rt_avai = 999.89
    if cont_bahia == 0:	
        Rt_bahia = 998.76
    ...
    if cont_figueirense == 0:	
        Rt_figueirense = 998.76
    if cont_flamengo == 0:	
        Rt_flamento = 996.98
    if cont_fluminense == 0:	
        Rt_fluminense = 1006.27
    if cont_fortaleza == 0:	
        Rt_fortaleza = 1000
    if cont_goias == 0:	
        Rt_goias = 1000.26
...
df_final.to_csv('ELO_2011.csv', index = False, sep = ';')
