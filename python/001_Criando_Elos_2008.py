...
df_pc2008_1 = df[df['Data'] >= '2008-01-01 00:00:00']
df_pc2008 = df_pc2008_1[df_pc2008_1['Data'] < '2009-01-01 00:00:00']
...
for index, row in jogos.iterrows():
    ...
    if cont_gremio_prudente == 0:	
        Rt_gremio_prudente = 1000
    if cont_guarani == 0:	
        Rt_guarani =1000
    if cont_internacional == 0:	
        Rt_internacional =1000
    if cont_ipatinga == 0:	
        Rt_ipatinga =1000
    if cont_joinville == 0:	
        Rt_joinville = 1000
...
df_final.to_csv('ELO_2008.csv', index = False, sep = ';')
