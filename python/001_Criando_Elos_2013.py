...
df_pc2008_1 = df[df['Data'] >= '2013-01-01 00:00:00']
df_pc2008 = df_pc2008_1[df_pc2008_1['Data'] < '2014-01-01 00:00:00']
...
df_final.to_csv('ELO_2013.csv', index = False, sep = ';')
