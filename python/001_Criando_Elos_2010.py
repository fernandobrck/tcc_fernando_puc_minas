...
df_pc2008_1 = df[df['Data'] >= '2010-01-01 00:00:00']
df_pc2008 = df_pc2008_1[df_pc2008_1['Data'] < '2011-01-01 00:00:00']
...
for index, row in jogos.iterrows():
    ...
    if cont_atl_mg == 0:
        Rt_Atletico_mg = 995.10
    if cont_amr_mg == 0:	
        Rt_americamg =1000
    if cont_atl_pr == 0:
        Rt_athletico_pr = 1004.94
    if cont_atl_go == 0:	
        Rt_atletico_go = 1000.66
    if cont_avai == 0:	
        Rt_avai = 1002.61
    if cont_bahia == 0:	
        Rt_bahia = 1000
...
df_final.to_csv('ELO_2010.csv', index = False, sep = ';')
