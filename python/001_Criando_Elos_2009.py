...
df_pc2008_1 = df[df['Data'] >= '2009-01-01 00:00:00']
df_pc2008 = df_pc2008_1[df_pc2008_1['Data'] < '2010-01-01 00:00:00']
...
for index, row in jogos.iterrows():
    ...
    if cont_atl_mg == 0:
        Rt_Atletico_mg = 1001.50
    if cont_amr_mg == 0:	
        Rt_americamg =1000
    if cont_atl_pr == 0:
        Rt_athletico_pr = 997.80
    if cont_atl_go == 0:	
        Rt_atletico_go = 1000
    if cont_avai == 0:	
        Rt_avai = 1000.45
    ...
    if cont_gremio_prudente == 0:	
        Rt_gremio_prudente = 0
    if cont_guarani == 0:	
        Rt_guarani =1000
    if cont_internacional == 0:	
        Rt_internacional = 998.30
    if cont_ipatinga == 0:	
        Rt_ipatinga =1000
    if cont_joinville == 0:	
        Rt_joinville = 1000
...
df_final.to_csv('ELO_2009.csv', index = False, sep = ';')
